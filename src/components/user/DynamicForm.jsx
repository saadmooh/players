...
export default function DynamicForm({ submitterName, teamName, coachPhone, tournamentType, onSuccess }) {
  ...
  async function onSubmit(values) {
    setSubmitting(true)
    try {
      await userAPI.submitPlayer({ ...values, _submitted_by: submitterName, _team_name: teamName, _coach_phone: coachPhone, _tournament_type: tournamentType })
      reset()
